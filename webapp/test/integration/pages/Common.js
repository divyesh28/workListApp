sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("worklist/worklistApplication/app", ".html");
		...
		return Opa5.extend("worklist.worklistApplication.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["worklist/worklistApplication/localService/mockserver"], function (mockserver) {
